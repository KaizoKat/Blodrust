...
public class Generator3D : MonoBehaviour {
    ...
    class Room {
        ...
        public Room(Vector3Int location, GameObject prefab) {
            bounds = new BoundsInt(location, new Vector3Int((int)prefab.transform.localScale.x,(int)prefab.transform.localScale.y,(int)prefab.transform.localScale.z));
        }
    ...
    void PlaceRooms() {
        for (int i = 0; i < roomCount; i++) {
            ...
            bool add = true;
            GameObject theRoom = Rooms[random.Next(0, Rooms.Length)];
            Room newRoom = new Room(location, theRoom);
            Room buffer = new Room(location + new Vector3Int(-1, 0, -1),  theRoom);
            ...
            if (add) {
                rooms.Add(newRoom);
                GameObject go = Instantiate(theRoom, location, Quaternion.identity);
    ...
    void PlaceHallway(Vector3Int location) {
        GameObject go = Instantiate(coridor, location, Quaternion.identity);
    }

    void PlaceStairs(Vector3Int location)
    {
        GameObject go = Instantiate(staircase, location, Quaternion.identity);
    }
}
